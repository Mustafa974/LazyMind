...
func loadWriterSlotDTOValue(ctx context.Context, db *gorm.DB, sessionID string, slot slotDTO) (json.RawMessage, error) {
	return loadWriterSlotRevisionValue(ctx, db, orm.PluginSlotRevision{
		SessionID:       sessionID,
...
func loadWriterSlotRevisionValue(ctx context.Context, db *gorm.DB, revision orm.PluginSlotRevision) (json.RawMessage, error) {
