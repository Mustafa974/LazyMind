...
func sessionIntentStartupInputs(value string) map[string]any {
	var intent struct {
		StartupInputs map[string]any `json:"startup_inputs"`
	}
	if json.Unmarshal([]byte(value), &intent) == nil {
		return intent.StartupInputs
	}
	return nil
}
